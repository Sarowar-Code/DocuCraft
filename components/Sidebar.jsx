...
const Sidebar = ({ docs }) => {
    ...
    const [nonRootNodesGrouped, setNonRootNodeGrouped] = useState({});
        ...
        <nav className="lg:block my-10">
            <ul>
                <div className="relative mt-3 pl-2">
                    <div className="absolute inset-y-0 top-0 bg-zinc-800/2.5 will-change-transform dark:bg-white/2.5"></div>
